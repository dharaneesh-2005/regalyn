...
export const products = pgTable("products", {
  ...
  specifications: text("specifications"), // Watch specifications (movement, case material, etc.)
  features: text("features"), // Watch features (water resistance, complications, etc.)
  rating: decimal("rating", { precision: 3, scale: 2 }),
  reviewCount: integer("review_count").default(0),
  sizeOptions: text("size_options").array(), // Watch sizes (38mm, 42mm, etc.)
  sizePrices: text("size_prices"), // JSON string to store size-price mappings
...
export interface SizePrice {
  [size: string]: string; // Maps size (e.g., "38mm") to price as string (e.g., "15000.00")
}
