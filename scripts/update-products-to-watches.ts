...
async function updateProductsToWatches() {
  try {
    console.log("Updating existing products to premium Regalyn watches...");

    // Update product ID 7 - Classic Automatic
    await db.update(products)
      .set({
        ...
        shortDescription: "Swiss automatic movement with 42-hour power reserve",
        price: "25000.00",
        comparePrice: "28000.00",
        badge: "Swiss Made",
        category: "Automatic",
        imageUrl: "https://images.unsplash.com/photo-1547996160-81dfa63595aa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        ...
        sizePrices: '{"38mm": "23000.00", "40mm": "25000.00", "42mm": "27000.00"}',
        rating: "4.8",
        reviewCount: 24,
        featured: true
      })
    ...
    // Update product ID 8 - Sport Chronograph
    await db.update(products)
      .set({
        ...
        shortDescription: "Precision chronograph with sports styling",
        price: "18000.00",
        comparePrice: "22000.00",
        badge: "Sport",
        category: "Sport",
        imageUrl: "https://images.unsplash.com/photo-1523170335258-f5ed11844a49?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        ...
        sizePrices: '{"40mm": "16000.00", "42mm": "18000.00", "44mm": "20000.00"}',
        rating: "4.6",
        reviewCount: 18,
        featured: true
      })
    ...
    // Update product ID 9 - Heritage Dress Watch
    await db.update(products)
      .set({
        ...
        shortDescription: "Classic dress watch with heritage design",
        price: "32000.00",
        comparePrice: "36000.00",
        badge: "Heritage",
        category: "Dress",
        imageUrl: "https://images.unsplash.com/photo-1594534475808-b18fc33b045e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        ...
        sizeOptions: ["36mm", "38mm", "40mm"],
        sizePrices: '{"36mm": "30000.00", "38mm": "32000.00", "40mm": "34000.00"}',
        rating: "4.9",
        reviewCount: 32,
        featured: true
      })
      .where(eq(products.id, 9));

    // Update product ID 10 - Limited Edition
    await db.update(products)
      .set({
        name: "Regalyn Limited Edition Platinum",
        slug: "regalyn-limited-edition-platinum",
        description: "A masterpiece of limited production, this exclusive timepiece features premium platinum construction, hand-finished details, and a unique serial number. Only 500 pieces worldwide, making it a true collector's investment.",
        shortDescription: "Limited edition luxury timepiece",
        price: "85000.00",
        comparePrice: "95000.00",
        badge: "Limited",
        category: "Limited Edition",
        imageUrl: "https://images.unsplash.com/photo-1606859970980-4d9bc6ee8097?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
